...
func getStrings() map[string]string {
	return map[string]string{
		...
		"WEALTH_A_NORMAL":      "A dinner out at the best restaurant in town.",
		"WEALTH_A_DEFAULT":     "Always into a good book or a gift card.",
		"ADVENTURE_A":          "What trip is on your bucket list?",
		"ADVENTURE_A_STRONG":   "I would go to the bottom of the ocean to deep sea dive.",
		"ADVENTURE_A_NORMAL":   "I've always wanted to get out of the country.",
		"ADVENTURE_A_DEFAULT":  "I'm more of a homebody, most of my trips are over my cats!.",
		"EXCITEMENT_A":         "What really gets your heart racing?",
		"EXCITEMENT_A_STRONG":  "Doing 30 on my unicycle, bombing hills with no helment on.",
		"EXCITEMENT_A_NORMAL":  "Paintball. Getting pelted in the face is a rush.",
		...
		"ROMANCE_A_DEFAULT":    "A piping hot TV-dinner and a good re-run.",
		"FAMILY_A":             "How do you feel about kids?",
		"FAMILY_A_STRONG":      "I already have names and schools picked out!",
